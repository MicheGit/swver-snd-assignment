...
\begin{frame}{Arithmetic Expressions - Semantics (1)}
    ...
    \begin{exampleblock}{$\mathcal{A} : AExp \to State \hookrightarrow \mathbb{Z} \times State $}
        \begin{flalign*}
            ...
            \end{cases} \\
            \semantics{A}{[e_1, e_2]} \varphi = & (a, \varphi'') \\
            \text{where } & (a_1, \varphi') = \semantics{A}{e_1} \varphi \\
            & (a_2, \varphi'') = \semantics{A}{e_2} \varphi' \\
            & a \text{ is a random integer between }a_1\text{ and }a_2
        \end{flalign*}
    \end{exampleblock}
\end{frame}
