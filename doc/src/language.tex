...
\begin{frame}{Boolean Expressions (1)}
    ...
    \begin{flalign*}
        BExp ::= & \texttt{true} \pipe \texttt{false} \pipe (b) \pipe b_1\,\,\texttt{and}\,\,b_2 \pipe b_1\,\,\texttt{or}\,\,b_2 \\ \pipe & e_1 \texttt{ = } e_2 \pipe e_1 \texttt{ != } e_2 \pipe \pipe e_1 \texttt{ < } e_2 \pipe e_1 \texttt{ >= } e_2 
    \end{flalign*}
